...
import java.util.*; //corrected java library
public class MathPractice {
    public static void main(String[] args) {
        ...
        double b = scanner.nextDouble(); //change obj name sc to scanner
        System.out.print("Enter angle (theta in degrees): ");
        double theta = scanner.nextDouble(); // change data type int to double 
        ...
        double P = scanner.nextDouble(); // change nextInt() to nextDouble()
        System.out.print("Enter Annual Interest Rate (r as a decimal): ");
        double r = scanner.nextDouble(); // change data type int to double
        System.out.print("Enter Number of Compounds per Year (n): ");
        int n = scanner.nextInt();
        System.out.print("Enter Time in Years (t): ");
        double t = scanner.nextDouble();
        double A = P * Math.pow(1 + r / n, n * t); // change POW to pow
